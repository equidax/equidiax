...
<html>
	<head>
		...
		<link rel="stylesheet" href="src/styles/suscribe.css" />
	</head>
	<body>
		<!-- Navigation -->
		<nav>
		...
		<div class="container">
            ...
            <form action="src/script/_Subscription.php" method="post">
                <!-- inputs -->
                 <div class="email">
                 ...
                 <div class="button">
                    <button type="submit" name="subscription">s'inscire</button>
                 </div>
            </form>
		</div>

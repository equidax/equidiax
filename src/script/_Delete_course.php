...
if(isset($_POST['check_course'])) {
    $id_course = htmlspecialchars($_POST['check_course']);
    // echo $id_course;
    ...
    echo "<div style='color: green;' class='message'>" . "Course supprimée... <a href='../../courses.php'>" . "Retour à la page des courses!" . "</a>" . "</div>";
